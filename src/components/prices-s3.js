...
class PricesS3 extends Component{
    render(){
        return(    
            <Container fluid className="prices-s3 d-flex minh-50vh align-items-center py-5 bg-dark border-top border-dark">
